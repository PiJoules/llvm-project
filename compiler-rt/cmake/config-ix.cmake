...
if(APPLE)
  ...
  list_intersect(RTSAN_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(CSAN_SUPPORTED_ARCH
    ALL_CSAN_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
...
set(ALL_SANITIZERS asan;rtsan;dfsan;msan;hwasan;tsan;tysan;safestack;cfi;scudo_standalone;ubsan_minimal;gwp_asan;nsan;asan_abi;csan)
