...
foreach(target x86_64-unknown-linux-gnu)
  ...
  if(LINUX_${target}_SYSROOT)
    ...
    #set(RUNTIMES_${target}_LLVM_USE_SANITIZER "Copy" CACHE STRING "")
    #set(RUNTIMES_${target}_LLVM_BUILD_COMPILER_RT OFF CACHE BOOL "")
    #set(RUNTIMES_${target}_LIBCXXABI_ENABLE_NEW_DELETE_DEFINITIONS OFF CACHE BOOL "")
    #set(RUNTIMES_${target}_LIBCXX_ENABLE_NEW_DELETE_DEFINITIONS OFF CACHE BOOL "")
