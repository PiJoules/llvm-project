...
Node *AbstractManglingParser<Derived, Alloc>::parseType() {
  ...
  case 'D':
    ...
    case 'A': {
      ...
      First += 3;
      switch (c) {
        case 's': return make<NameType>("short _Accum");
        case 't': return make<NameType>("unsigned short _Accum");
        case 'i': return make<NameType>("_Accum");
        case 'j': return make<NameType>("unsigned _Accum");
        case 'l': return make<NameType>("long _Accum");
        case 'm': return make<NameType>("unsigned long _Accum");
    ...
    case 'R': {
      ...
      First += 3;
      switch (c) {
        case 's': return make<NameType>("short _Fract");
        case 't': return make<NameType>("unsigned short _Fract");
        case 'i': return make<NameType>("_Fract");
        case 'j': return make<NameType>("unsigned _Fract");
        case 'l': return make<NameType>("long _Fract");
        case 'm': return make<NameType>("unsigned long _Fract");
        default: return nullptr;
      }
    }
    case 'S': {
      ...
      if (look(1) == 'A') {
        ...
        First += 3;
        switch (c) {
          case 's': return make<NameType>("_Sat short _Accum");
          case 't': return make<NameType>("_Sat unsigned short _Accum");
          case 'i': return make<NameType>("_Sat _Accum");
          case 'j': return make<NameType>("_Sat unsigned _Accum");
          case 'l': return make<NameType>("_Sat long _Accum");
          case 'm': return make<NameType>("_Sat unsigned long _Accum");
          default: return nullptr;
        }
      }
      if (look(1) == 'R') {
        ...
        First += 3;
        switch (c) {
          case 's': return make<NameType>("_Sat short _Fract");
          case 't': return make<NameType>("_Sat unsigned short _Fract");
          case 'i': return make<NameType>("_Sat _Fract");
          case 'j': return make<NameType>("_Sat unsigned _Fract");
          case 'l': return make<NameType>("_Sat long _Fract");
          case 'm': return make<NameType>("_Sat unsigned long _Fract");
          default: return nullptr;
        }
      }
      return nullptr;
